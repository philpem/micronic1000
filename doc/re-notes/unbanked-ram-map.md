...
| `D681`-`D892` | 530 | DIPOS dispatch block: syscall dispatch, boot-chain walker, `RST 10h` cross-bank thunk, `Coroutine_TaskSwitch` | CONFIRMED | `ROM00:3BAA` `21 30 70 / 11 81 D6 / 01 12 02 / ED B0 / C3 81 D6` — LDIR `ROM00:7030 → D681`, `0x212` bytes, then jump into it |
